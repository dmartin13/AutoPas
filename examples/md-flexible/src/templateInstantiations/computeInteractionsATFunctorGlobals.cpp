/**
 * @file computeInteractionsATFunctorGlobals.cpp
 *
 * Contains an explicit template instantiation for the computeInteractions() method with the appropriate auto-vectorized
 * Axilrod-Teller Functor with globals and Particle Type, as determined by whether md-flexible is compiled with or
...
template bool autopas::AutoPas<ParticleType>::computeInteractions(ATFunctorGlobals *);
//! @endcond
